...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2025 at 04:41 PM
...
--
ALTER TABLE `login`
  ADD CONSTRAINT `login_ibfk_1` FOREIGN KEY (`id_member`) REFERENCES `member` (`id_member`) ON DELETE CASCADE;
COMMIT;
